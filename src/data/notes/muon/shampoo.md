...
source:
  ...
  url: "https://github.com/J-shang/Muon/blob/ae2b5f9e6ee06b411aef2220e361c75988a7d753/%E8%AE%BA%E6%96%87%E7%B2%BE%E8%AF%BB/01-Shampoo.md"
  revision: "ae2b5f9e6ee06b411aef2220e361c75988a7d753"
  syncedAt: "2026-07-14"
  contentHash: "sha256:bd6b4f94fb2084abfed9948c535fa2e3507f706e35a26c63a0864420280fb06e"
  manifest: "muon"
  managed: true
---
> source: [ICML 2018 / PMLR](https://proceedings.mlr.press/v80/gupta18a.html)
> source class: 同行评审会议论文
> confidence: 代数推导 `verified`；论文训练收益限于其报告设置
...
- **Muon 相关性**：它提供一个强基线和精确的“删掉了哪些二阶历史”的对照。

## 知识关系

- `predecessor-of` → SOAP 等结构化 preconditioner。
- `special-case relation` → instantaneous 版本在上述条件下得到 polar。
- `not-equivalent-to` → 实际 Muon，因为 persistent state、update object 和数值路径不同。
...
| instantaneous Shampoo 等于 $UV^\top$ | **不在 2018 原论文中作为主张出现**；见 *Old Optimizer, New Norm* Story II 和 Muon 原始说明 | `后续论文 + 仓库内 SVD 推导`，已纠正归因 |
| $m^2+n^2$ state 与 Muon $mn$ 的比较 | 由算法 shape 直接计数 | `仓库内字节/元素推导`，未含 blocking/dtype/temporary buffers |
